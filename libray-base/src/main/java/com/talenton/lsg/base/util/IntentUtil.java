...
public class IntentUtil {
    ...
    public static Intent getCameraIntent(File imageFile, int sizeLimit) {
        ...
        AppLogger.d("Launch camera for photo: " + imageFile.getAbsolutePath());
        return intent;
    }
    ...
    public static Intent getCameraIntent(Uri imageUri, int sizeLimit) {
        ...
        if (sizeLimit != -1) intent.putExtra(MediaStore.EXTRA_SIZE_LIMIT, sizeLimit);
        AppLogger.d("Launch camera for photo: " + imageUri.toString());
        return intent;
    }
    ...
    public static void scanImageMediaStore(File file) {
        ...
        XltApplication.getAppContext().sendBroadcast(scanFileIntent);
    }
...
//        intent.setType(MIME_IMAGE);
    ...
    public static boolean isInstalledByMarket(Context context) {
        try {
            ...
            return XltApplication.getAppContext().getPackageName().equals(
