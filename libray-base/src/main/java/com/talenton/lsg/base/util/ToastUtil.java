...
public class ToastUtil {
     ...
     * 维护toast的队列
     */
    private static BlockingQueue<ToastUtil> mQueue = new LinkedBlockingDeque<>();
    /**
    ...
    public static ToastUtil makeText(Context context, String text, long duration) {
        return new ToastUtil(context).setText(text).setDuration(duration);
    }
    ...
    public ToastUtil setDuration(long durationMillis) {
        if (durationMillis < 0) {
            mDurationMillis = 0;
        }
    ...
    public ToastUtil setMargin(float horizontalMargin, float verticalMargin) {
    ...
    private static void activeQueue() {
        ToastUtil miuiToast = mQueue.peek();
        if (miuiToast == null) {
    ...
    public static boolean isNotificationEnabled(Context context) {
        ...
        try {
            ...
            //Log.d("test", ""+checkOpNoThrowMethod.invoke(mAppOps,value, uid, pkg));
