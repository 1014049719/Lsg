...
public class FeedsDetailAdapter extends BaseAdapter implements View.OnClickListener, View.OnLongClickListener {
	...
	private FeedsItemLayout mFeedsHolder;
	...
	public FeedsDetailAdapter(Context context, PostToParam postTo) {
	...
	public void addComments(LinkedList<CommentInfo> comments){
	...
	public View getFeedsView(View convertView, ViewGroup parent) {
		if (convertView == null || mFeedsHolder == null) {
			convertView = inflater.inflate(R.layout.item_feeds_detail, parent, false);
			mFeedsHolder = new FeedsItemLayout(mContext, convertView, new OnFeedsClickListener(mContext, mPostToParam));
	...
	public void showlikePopWindow(final View locationView, boolean isAnonymous) {
	}
