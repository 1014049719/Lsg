...
import com.talenton.lsg.base.server.bean.ReqLogin;
...
public class UserServer{
    ...
    public static boolean needManuallyLogIn() {
       ...
       // +" 3:"+!getCurrentAuthority().isLegal()+ " 4:"+!UserServer.getCurrentUser().checkUserInfo());
        return mManuallyLogIn || getCurrentUser().uid <= 0 || !getCurrentAuthority().isLegal() || !UserServer.getCurrentUser().checkUserInfo();
    }
