...
-keep class com.talenton.lsg.base.dao.** {*;}
-keep class **.R$* {*;}
-keep class com.talenton.lsg.base.widget.** {*;}
-keep class com.talenton.lsg.base.util.** {*;}
-keep class com.talenton.lsg.widget.** {*;}
-keep class com.talenton.lsg.util.** {*;}
-keep class com.talenton.lsg.wxapi.** {*;}
-keep class com.talenton.lsg.base.okhttp.https.** {*;}
### lsg sdk end
