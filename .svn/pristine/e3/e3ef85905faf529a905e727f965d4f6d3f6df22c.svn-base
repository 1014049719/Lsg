...
public class MyAdapter extends LSGBaseAdapter<Discovery> {
    ...
    public void clearRedActionnum(int actionnum) {

        this.getDatas().get(1).number = actionnum;
        notifyDataSetChanged();
    }
    public void clearRedMessagenum(int messagenum) {

        this.getDatas().get(2).number = messagenum;
        notifyDataSetChanged();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.discovery_cell, parent,false);
