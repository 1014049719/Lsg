...
public class FeedsBeanDao extends AbstractDao<FeedsBean, String> {
    ...
    /**
     * Properties of entity FeedsBean.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property PhotoTime = new Property(6, Long.class, "photoTime", false, "PHOTO_TIME");
        public final static Property Content = new Property(7, String.class, "content", false, "CONTENT");
    };


    public FeedsBeanDao(DaoConfig config) {
        super(config);
    }
    
    public FeedsBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'FEEDS_BEAN' (" + //
                ...
                "'PHOTO_TIME' INTEGER," + // 6: photoTime
                "'CONTENT' TEXT);"); // 7: content
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_FEEDS_BEAN_GUID ON FEEDS_BEAN" +
                " (GUID);");
        db.execSQL("CREATE INDEX " + constraint + "IDX_FEEDS_BEAN_DTYPE ON FEEDS_BEAN" +
                " (DTYPE);");
        db.execSQL("CREATE INDEX " + constraint + "IDX_FEEDS_BEAN_PHOTO_TIME ON FEEDS_BEAN" +
                " (PHOTO_TIME);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'FEEDS_BEAN'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, FeedsBean entity) {
        stmt.clearBindings();
        ...
        Long photoTime = entity.getPhotoTime();
        if (photoTime != null) {
            stmt.bindLong(7, photoTime);
        }
    ...
    /** @inheritdoc */
    @Override
    public FeedsBean readEntity(Cursor cursor, int offset) {
        FeedsBean entity = new FeedsBean( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getLong(offset + 6), // photoTime
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, FeedsBean entity, int offset) {
        ...
        entity.setPhotoTime(cursor.isNull(offset + 6) ? null : cursor.getLong(offset + 6));
        entity.setContent(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
     }
    
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(FeedsBean entity, long rowId) {
        return entity.getGuid();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(FeedsBean entity) {
        if(entity != null) {
            return entity.getGuid();
        } else {
            return null;
